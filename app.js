...
const RISK = {
  flood:   { pts:[[35.665,139.640,.9],[35.660,139.645,.7],[35.655,139.650,.85],[35.670,139.635,.6],[35.645,139.660,.8],[35.658,139.625,.7]], c:{h:'rgba(0,110,220,.52)',m:'rgba(0,80,200,.35)',l:'rgba(60,130,220,.22)'} },
  quake:   { pts:[[35.660,139.620,.8],[35.645,139.640,.65],[35.635,139.650,.75],[35.672,139.655,.5]], c:{h:'rgba(210,43,43,.52)',m:'rgba(240,100,0,.38)',l:'rgba(245,166,35,.28)'} },
  liq:     { pts:[[35.655,139.645,.9],[35.648,139.655,.8],[35.660,139.658,.6],[35.643,139.648,.75]], c:{h:'rgba(200,150,0,.55)',m:'rgba(220,180,0,.4)',l:'rgba(240,210,0,.28)'} },
  tsunami: { pts:[[35.610,139.680,.9],[35.618,139.670,.8],[35.625,139.665,.6],[35.605,139.688,.95]], c:{h:'rgba(0,170,150,.52)',m:'rgba(0,145,130,.38)',l:'rgba(0,200,180,.22)'} },
};
